...
text-shadow:1px 1px 4px rgba(0,0,0,0.6);
  ...
  <div class="backbutton">
   <img style="width:80px;vertical-align:middle" src="<?php bloginfo('url');?>/wp-content/uploads/2015/01/d_isolated.png">
   <span style="">Back to <a href="">The Dartmouth</a></span>
</div>
	<div class="intro">
