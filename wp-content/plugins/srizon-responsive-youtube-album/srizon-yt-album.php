...
function srz_yt_options_page(){
	...
	/*todo: save and get common options*/
	...
	echo '<div>For better functionality, layouts and options get the <a href="http://www.srizon.com/wordpress-plugin/srizon-youtube-album">Pro version</a></div>
	<h5>Pro Features:</h5>
	<ol>
...
function srz_yt_albums_save(){
	if( wp_verify_nonce($_POST['srjyt_submit'],'srz_yt_albums') == false ) die('Nice Try!');
	if(!isset($_POST['id'])){
