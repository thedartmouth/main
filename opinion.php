...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	<title>The Dartmouth - Opinion</title>
	...
	<div class="content container-fluid">
		<div class="row-fluid">
			...
			<div id="staticcontent">
				<div class="span9" >
					<h1>Opinion</h1><div class="row-fluid">

					<!--<ul class="nav nav-tabs" id="tabs">
					  <li><a href="#verbum" data-toggle="tab">Verbum Ultimum</a></li>
					  <li><a href="#staff" data-toggle="tab">Staff Columnists</a></li>
					  <li><a href="#guest" data-toggle="tab">Guest Columnists</a></li>
					  <li><a href="#letters" data-toggle="tab">Letters</a></li>
					  <li><a href="#comic" data-toggle="tab">Comics</a></li>
					  <li><a href="#crossword" data-toggle="tab">Crosswords</a></li>
					</ul>-->
